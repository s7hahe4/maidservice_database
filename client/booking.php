...
<body>
    ...
    if($_POST){
        if(isset($_POST["booknow"])){
            ...
            $date=$_POST["date"];
            $scheduleid=$_POST["scheduleid"];
            $sql2="insert into appointment(clientid, apponum, scheduleid, appodate) values ($userid, $apponum, $scheduleid, '$date')";
                ...
                <tr >
                    ...
                    <td >
                            <form action="schedule.php" method="post" class="header-search">
                                        ...
                                        $list11 = $database->query("select DISTINCT * from maid;");
                                        ...
                                        <div  class="dashboard-items search-items"  >
                                            ...
                                            <div style="width:100%">
                                                    ...
                                                    <div class="h3-search" style="font-size:18px;line-height:30px">
                                                        Maid name:  &nbsp;&nbsp;<b>'.$maidname.'</b><br>
                                                        Maid Email:  &nbsp;&nbsp;<b>'.$maidemail.'</b> 
                                                    </div>
