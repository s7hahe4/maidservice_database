                                    ...
                                    <td style="width: 25%;">
                                            <div class="dashboard-items search-items">
                                                ...
                                                <div class="h3-search">
                                                        ...
                                                        <br>
                                                        <a href="?action=drop&id='.$appoid.'&title='.$title.'&maid='.$maidname.'" ><button class="login-btn btn-primary-soft btn" style="padding-top:11px;padding-bottom:11px;width:100%"><font class="tn-in-text">Cancel Booking</font></button></a>
                                                </div>
    ...
    if($_GET){
        ...
        if($action=='booking-added'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <div class="content">
                            ...
                            Maid name&nbsp; : <b>'.substr($maidname,0,40).'</b><br><br>
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        <h2></h2>
                        <a class="close" href="maids.php">&times;</a>
                        <div class="content">
                            eDoc Web App<br>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td colspan="2">
                                    <a href="maids.php"><input type="button" value="OK" class="login-btn btn-primary-soft btn" ></a>
