            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-patient">
                        <a href="client.php" class="non-style-link-menu"><div><p class="menu-text">My Customers</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
        ...
        <div class="dash-body" style="margin-top: 15px">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;" >
                        ...
                        <tr >
                            ...
                            <td width="10%">
                                <button  class="btn-label"  style="display: flex;justify-content: center;align-items: center;"><img src="" width="100%"></button>
                            </td>
                ...
                <tr>
                    ...
                    <tr>
                        <td >
                            ...
                            <a href="appointment.php" class="non-style-link"><button class="btn-primary btn" style="width:30%">Add avaibality</button></a>
                            <br>
                            <br>
                        </td>
                    </tr>
    ...
    <div class="dashboard-items" style="padding:20px;margin:auto;width:95%;display: flex;">
        <div>
            <div class="h1-dashboard">
                <?php echo $userid; // Display the logged-in maid's ID ?>
            </div><br>
                                    ...
                                    <center>
                                        ...
                                        <tbody>
                                            ...
                                            $sqlmain= "select schedule.scheduleid,schedule.title,maid.maidname,schedule.scheduledate,schedule.scheduletime,schedule.nop 
                                                       from schedule inner join maid on schedule.maidid=maid.maidid  
