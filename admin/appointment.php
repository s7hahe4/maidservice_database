    ...
    <div class="container">
        <div class="menu">
            <table class="menu-container" border="0">
                        ...
                        <table border="0" class="profile-container">
                            <tr>
                                ...
                                <td style="padding:0px;margin:0px;">
                                    ...
                                    <p class="profile-subtitle">admin@maidservice.com</p>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-tor ">
            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                ...
                <tr>
                    <td colspan="4" style="padding-top:0px;width: 100%;" >
                        ...
                        <td width="30%">
                        <select name="id" id="" class="box filter-container-items" style="width:90% ;height: 37px;margin: 0;" >
                            <option value="" disabled selected hidden>Choose maid Name from the list</option><br/>
                                
                            <?php 
                             
                                $list11 = $database->query("select  * 
                                                            from  maid 
                                                            order by maidname asc;");
                ...
                if($_POST){
                    ...
                    $sqlmain= "select appointment.appoid, schedule.scheduleid, schedule.title, maid.maidname, client.clientname, schedule.scheduledate, schedule.scheduletime, appointment.apponum, appointment.appodate from schedule inner join appointment on schedule.scheduleid=appointment.scheduleid inner join client on client.clientid=appointment.clientid inner join maid on schedule.maidid=maid.maidid order by schedule.scheduledate desc";
                }
                ?>
                        ...
                        if($result->num_rows==0){
                            ...
                            for ($x=0; $x<$result->num_rows; $x++){
                                ...
                                echo '<tr>
                                    ...
                                    substr($clientname,0,25)
                                    .'</td>
                                    <td style="text-align:center;font-size:23px;font-weight:500; color: var(--btnnicetext);">
                                    '.$apponum.'
                                    </td>
                                    <td>
                                    '.substr($maidname,0,25).'
                                    </td>
                                    <td>
                                    '.substr($title,0,15).'
                                    </td>
                                ...
                                &nbsp;&nbsp;&nbsp;-->
                                <a href="?action=drop&id='.$appoid.'&name='.$clientname.'&session='.$title.'&apponum='.$apponum.'" class="non-style-link"><button class="btn-primary-soft btn button-icon btn-delete" style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">Cancel</font></button></a>
                                &nbsp;&nbsp;&nbsp;</div>
                                    </td>
                                </tr>';
                            }
        ...
        if($action=='add-session'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <div style="display: flex;justify-content: center;">
                        <div class="abc">
                        <table width="80%" class="sub-table scrolldown add--form-container" border="0">
                        <tr>
                            ...
                            <tr>
                                ...
                                <td class="label-td" colspan="2">
                                    <label for="maidid" class="form-label">Select Maid: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                    <select name="maidid" id="" class="box" >
                                    <option value="" disabled selected hidden>Choose Maid Name from the list</option><br/>';

                                        $list11 = $database->query("select  * from  maid;");
                                        for ($y=0;$y<$list11->num_rows;$y++){
                                            $row00=$list11->fetch_assoc();
                                            $sn=$row00["maidname"];
                                            $id00=$row00["maidid"];
